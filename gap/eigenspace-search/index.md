The eye-J.txt file is read by eigenspace-search, to define some required functions.   
The [sample input](sample input/index.md) folder includes some graphs that have strongly regular decompositions so the search will return something, as well as the Klin63 graphs which does not.  
